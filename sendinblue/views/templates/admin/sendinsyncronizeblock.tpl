...
<div class="form-box">
<h2 class="heading"><img src="{$local_path|escape:'quotes':'UTF-8'}{$name|escape:'quotes':'UTF-8'}/views/img/logo_sib.png" alt="" />{l s='Activate SendinBlue to manage contacts' mod='sendinblue'}</h2>
